...
export const localPostDeleteHistoryByAgeRpcPromise = (params: LocalPostDeleteHistoryByAgeRpcParam, waitingKey?: string): Promise<LocalPostDeleteHistoryByAgeResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postDeleteHistoryByAge', params, callback: (error: RPCError, result: LocalPostDeleteHistoryByAgeResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const localPostFileAttachmentMessageLocalNonblockRpcPromise = (params: LocalPostFileAttachmentMessageLocalNonblockRpcParam, waitingKey?: string): Promise<LocalPostFileAttachmentMessageLocalNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postFileAttachmentMessageLocalNonblock', params, callback: (error: RPCError, result: LocalPostFileAttachmentMessageLocalNonblockResult) => (error ? reject(error) : resolve(result)), waitingKey}))
export const localPostFileAttachmentUploadLocalNonblockRpcPromise = (params: LocalPostFileAttachmentUploadLocalNonblockRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postFileAttachmentUploadLocalNonblock', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export const localPostReactionNonblockRpcPromise = (params: LocalPostReactionNonblockRpcParam, waitingKey?: string): Promise<LocalPostReactionNonblockResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.postReactionNonblock', params, callback: (error: RPCError, result: LocalPostReactionNonblockResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export const localSetConvMinWriterRoleLocalRpcPromise = (params: LocalSetConvMinWriterRoleLocalRpcParam, waitingKey?: string): Promise<void> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'chat.1.local.setConvMinWriterRoleLocal', params, callback: (error: RPCError, result: void) => (error ? reject(error) : resolve()), waitingKey}))
...
export type LocalGetSearchRegexpRpcParam = $ReadOnly<{conversationID: ConversationID, query: String, isRegex: Boolean, sentBy: String, maxHits: Int, maxMessages: Int, beforeContext: Int, afterContext: Int, identifyBehavior: Keybase1.TLFIdentifyBehavior}>
...
export type LocalMakePreviewRpcParam = $ReadOnly<{filename: String, outboxID: OutboxID}>
...
export type LocalPostFileAttachmentLocalRpcParam = $ReadOnly<{arg: PostFileAttachmentArg}>
export type LocalPostFileAttachmentMessageLocalNonblockRpcParam = $ReadOnly<{convID: ConversationID, tlfName: String, visibility: Keybase1.TLFVisibility, clientPrev: MessageID, ephemeralLifetime?: ?Gregor1.DurationSec, identifyBehavior: Keybase1.TLFIdentifyBehavior}>
export type LocalPostFileAttachmentUploadLocalNonblockRpcParam = $ReadOnly<{convID: ConversationID, outboxID: OutboxID, filename: String, title: String, metadata: Bytes, callerPreview?: ?MakePreviewRes, identifyBehavior: Keybase1.TLFIdentifyBehavior}>
...
export type LocalSetConvMinWriterRoleLocalRpcParam = $ReadOnly<{convID: ConversationID, role: Keybase1.TeamRole}>
...
export type NotifyChatChatAttachmentUploadProgressRpcParam = $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, outboxID: OutboxID, bytesComplete: Long, bytesTotal: Long}>
export type NotifyChatChatAttachmentUploadStartRpcParam = $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, outboxID: OutboxID}>
...
export type NotifyChatChatSetConvSettingsRpcParam = $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, conv?: ?InboxUIItem}>
...
export type NotifyChatChatSubteamRenameRpcParam = $ReadOnly<{uid: Keybase1.UID, convID: ConversationID, conv?: ?InboxUIItem}>
...
export type NotifyChatNewChatActivityRpcParam = $ReadOnly<{uid: Keybase1.UID, activity: ChatActivity, source: ChatActivitySource}>
...
export type RemoteGetTLFConversationsRpcParam = $ReadOnly<{tlfID: TLFID, topicType: TopicType, summarizeMaxMsgs: Boolean, useCache: Boolean}>
...
export type RemoteSetConvMinWriterRoleRpcParam = $ReadOnly<{convID: ConversationID, role: Keybase1.TeamRole}>
...
type LocalPostFileAttachmentMessageLocalNonblockResult = PostLocalNonblockRes
...
type RemoteSetConvMinWriterRoleResult = SetConvMinWriterRoleRes
